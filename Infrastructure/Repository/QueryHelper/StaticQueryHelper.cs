...
namespace Infrastructure.Repository.QueryHelper
{
    internal static class StaticQueryHelper
    {
        public static KeyValuePair<string, string> InsertDictionaryToStrings(Dictionary<string, object> dict, string tableName)
        {
        ...
        {
            return InsertDictionaryToStrings(dict, null);
        }
